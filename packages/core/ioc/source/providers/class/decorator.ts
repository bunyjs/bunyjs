        ...
        registers.push({
          handler: ({ container, provider }) => {
            try {
              ...
              registerContext.provider = provider as ClassProvider<T>;
        ...
        resolvers.push({
          handler: ({ container, provider, instance }) => {
            try {
              ...
              resolveContext.provider = provider as ClassProvider<T>;
              resolveContext.instance = instance as T;
        ...
        disposers.push({
          handler: ({ container, provider, instance }) => {
            try {
              ...
              disposeContext.provider = provider as ClassProvider<T>;
              disposeContext.instance = instance as T;
